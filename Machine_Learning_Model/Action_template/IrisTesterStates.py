...
class_names = ["up", "down", "centre", "right", "left"]
...
def main(inp):
    ...
    with open('S:\GitPro\BCI4Kidz\Machine_Learning_Model\Action_template\iris_states_test_gb.pkl', 'rb') as f:
        model = pickle.load(f)
        with mp_face_mesh.FaceMesh(
            ...
            for idx, (frame, frame_rgb) in enumerate(source):
                ...
                if landmarks is not None:
                    ...
                    cv2.putText(frame, str(class_names[body_language_class])
